...
<html>
    ...
    <body>
        <form id="get-data-form" name="get-data-form" method="post" action="save.php">
            ...
            if ($version==1){
                echo "<input type=\"hidden\" name=\"fileName\" id=\"fileName\" value=\"projects/$projectid/$nodeid/main.txt\">";
            }
            else{
                echo "<input type=\"hidden\" name=\"fileName\" id=\"fileName\" value=\"projects/$projectid/$nodeid/main_$version.txt\">";
            }
            ?>
