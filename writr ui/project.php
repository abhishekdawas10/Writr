...
<html lang="en">
    ...
    $userid=$_SESSION["user_id"];
        ...
        <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['name']) && isset($_POST['desc'])) {
        ...
        <section id="contact">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading text-uppercase">Add Contributors to your project!</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <form method="post" action="adduser.php">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control" name="username" id="username" type="text" placeholder="Username" required data-validation-required-message="Please enter another user's username.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="clearfix"></div>
                                <div id="success"></div>
