...
if(isset($_SESSION["VALID_USER_ID"]))
{
	...
	$check_user_details = mysqli_query($connection,"select * from `follow_and_unfollow_users_table` where `email` = '".mysqli_real_escape_string($connection,$page_owner)."'");
...
{
	$check_following_or_not = mysqli_query($connection,"select * from `follow_and_unfollow_activity` where `page_owners_emails` = '".mysqli_real_escape_string($connection,$page_owner)."' and `followers_emails` = '".mysqli_real_escape_string($connection,$_SESSION["VALID_USER_ID"])."'");
...
$check_users_in_the_system = mysqli_query($connection,"select * from `follow_and_unfollow_users_table` order by `id` desc limit 100");
