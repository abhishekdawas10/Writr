...
if(isset($_POST["submitted"]) && $_POST["submitted"] == "yes")
{
	...
	$check_for_duplicates = mysqli_query($connection,"select * from `follow_and_unfollow_users_table` where `email` = '".mysqli_real_escape_string($connection,$user_email)."'");
